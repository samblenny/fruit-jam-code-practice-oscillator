...
straight key frame uses flexure springs that are fine to print in PLA. I used
the standard Bambu Studio 0.2mm layer height preset modified to calibrate my
